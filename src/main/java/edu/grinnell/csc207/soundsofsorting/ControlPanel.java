    ...
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Integer[] arrCopy = Arrays.copyOf(notes.getNotes(), notes.getNotes().length);
                String sortType = (String) sorts.getSelectedItem();
                List<SortEvent<Integer>> events = generateEvents(sortType, arrCopy);
                    ...
                    public void run() {
                        if (index < events.size()) {
                            ...
                            for (int i = 0; i < affectedInd.size(); i++) {
                                ...
                                scale.playNote(affectedInd.get(i), true);
                            }
                            panel.repaint();
                        } else {
                            this.cancel();
